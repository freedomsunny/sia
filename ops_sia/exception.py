...
class NotExist(NotFound):
    message = "Resource could not be found."


class FileFormatException(OpsException):
    code = 500
    message = "file format %(file_format)s is not valid"


class UpLoadFileError(OpsException):
    code = 500
    message = "upload file %(file_name)s error"